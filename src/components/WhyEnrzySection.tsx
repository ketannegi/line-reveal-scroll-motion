  ...
  return (
    <div ref={sectionRef} className="bg-background section-padding px-6 overflow-hidden">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="why-image relative bg-gradient-to-br from-gray-100 to-gray-200 rounded-2xl h-64 md:h-96 flex items-center justify-center shadow-lg mb-8 md:mb-12">
          <img
