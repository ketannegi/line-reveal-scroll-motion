...
const CounterSection = () => {
  ...
  const stats: StatItem[] = [
    { number: "200+", label: "Delighted Customers", value: 200, suffix: "+" },
    { number: "25+", label: "Ongoing Projects", value: 25, suffix: "+" },
    { number: "20+", label: "Years of Experience", value: 20, suffix: "+" },
          ...
          {stats.map((stat, index) => (
            ...
            >
              <div className="relative w-100">
                ...
                {/* Animated underline */}
                {/* <div 
                  className={`mx-auto mt-3 bg-white/30 transition-all duration-1000 ${
